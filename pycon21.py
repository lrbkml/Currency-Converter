...
my_pic = Image.open("wlp.jpg")
resized = my_pic.resize((380, 450), Image.BOX)
...
convert = Button(root, font=('arial', 15, 'bold'), text="Convert", padx=2, pady=2, bg="blue", fg="white",
